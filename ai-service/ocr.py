...
# EasyOCR model files are stored in the directory set by EASYOCR_MODEL_DIR
# (default: /app/easyocr_models). Mount pre-downloaded models at that path
# to avoid downloading on startup (controlled by RESUME_OCR_MODEL_DOWNLOAD_ENABLED).
# Model file paths (inside the model dir):
#   craft_mlt_25k.pth  — text detection
#   latin_g2.pth       — Latin/English recognition
#   cyrillic_g2.pth    — Russian/Cyrillic recognition
